...
const HomeScreen = ({ navigation }) => {
  ...
  const renderTransaction = ({ item }) => (
    <View style={styles.transactionItem}>
      ...
      {/* `description`'ı burada doğru şekilde gösterdiğinizden emin olun */}
      {item.description ? (
        <Text style={styles.transactionsText}>Açıklama: {description}</Text>
      ) : (
        <Text style={styles.transactionsText}>Açıklama bulunamadı</Text>
      )}
