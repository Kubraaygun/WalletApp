...
const HomeScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    // Bakiyenin animasyonlu olarak değişmesini sağla
    Animated.sequence([
      // Bakiyeyi 0'dan hedef değere animasyonla yükselt
      Animated.timing(animatedBalance, {
        toValue: balance,
        duration: 800,
        useNativeDriver: false, // useNativeDriver false çünkü animasyon sadece opaklık gibi değerleri etkiliyor
      }),
      // Dönme animasyonu
      Animated.timing(rotate, {
        toValue: 1,
        duration: 500,
        useNativeDriver: true, // useNativeDriver true çünkü bu animasyon dönüş ile ilgili
      }),
      ...
      Animated.parallel([
        Animated.spring(scale, {
          ...
          friction: 3,
          tension: 50,
          useNativeDriver: true, // useNativeDriver true çünkü bu animasyon sadece scale'ı etkiliyor
        }),
        Animated.timing(colorChange, {
          toValue: 1,
          duration: 400,
          useNativeDriver: false, // Renk değişimi için useNativeDriver false
        }),
      ]),
      ...
      Animated.timing(translateY, {
        ...
        duration: 200,
        useNativeDriver: true, // Y eksenindeki hareket için useNativeDriver true
      }),
      Animated.timing(translateY, {
        toValue: 0,
        duration: 200,
  ...
  }, [balance]); // balance değiştiğinde animasyonu başlat
        ...
        >
          ...
          <Animated.Text
            style={[
              styles.balanceText,
              {
                opacity: animatedBalance.interpolate({
