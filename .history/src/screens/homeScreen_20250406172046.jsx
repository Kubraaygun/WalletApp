    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.PRIMARY }}>
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <CustomButton title="Sifirla" onPress={handleReset} />
        </View>
      </View>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  transactionItem: {
    ...
    shadowOffset: { width: 0, height: 4 }, // Gölgenin ofseti (sağa ve yukarı)
    shadowOpacity: 0.1, // Gölgenin opaklığı
    shadowRadius: 3, // Gölgenin yayılma büyüklüğü
  ...
  buttonContainer: {
    ...
    position: "absolute", // Butonları sabitlemek için absolute kullanıyoruz
    bottom: 30, // Alt kısmına 30px mesafe bırakıyoruz
    width: "100%",
    alignItems: "center",
    zIndex: 999, // Butonların diğer içeriklerin önünde olmasını sağlar
  },
});
