...
const HomeScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    Animated.timing(animatedBalance, {
      toValue: balance, // Yeni bakiye değeri
      duration: 3000, // 1 saniyelik animasyon
      useNativeDriver: false, // CSS animasyonu gibi kullanılır
    }).start();
  }, [balance]); // Balance değiştikçe animasyonu tetikle/ Balance değiştikçe animasyonu tetikle
  const handleReset = () => {
  ...
  const balanceInterpolation = animatedBalance.interpolate({
    inputRange: [0, 3000], // Bu aralık örnek olarak alındı, ihtiyaca göre değiştirilebilir
