...
const HomeScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    Animated.sequence([
      // İlk olarak bakiyeyi 0'dan hedef değere animasyonla yükselt
      Animated.timing(animatedBalance, {
        toValue: balance,
        duration: 800, // Animasyon süresi
        useNativeDriver: false,
      }),
      // Bakiye güncellendikten sonra bir büyütme/küçültme efekti ekle
      Animated.spring(scale, {
        toValue: 1.2, // Büyütme
        friction: 3, // Daha yumuşak geçiş
        tension: 50, // Büyütme efekti
  ...
  }, [balance]); // Balance değiştikçe animasyonu tetikle
  const balanceInterpolation = animatedBalance.interpolate({
    ...
    outputRange: ["0", balance.toString()], // Yeni bakiye
  });
  const handleReset = () => {
          ...
          <Animated.Text
            style={[
              styles.balanceText,
              {
                ...
                transform: [{ scale }], // Büyütme/küçültme efekti
              },
            ]}
          >
