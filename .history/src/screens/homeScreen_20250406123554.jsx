...
import { resetBalence } from "../store/walletSlice";
const HomeScreen = ({ navigation }) => {
  ...
  const renderTransaction = ({ item }) => (
    <View style={styles.transactionItem}>
      <Text style={styles.transactionsText}>ALICI: {item.receiver}</Text>
      <Text style={styles.transactionsText}>MIKTAR: ₺ {item.amount}</Text>
      <Text style={styles.transactionsText}>TARIH: {item.date}</Text>
    </View>
  );
