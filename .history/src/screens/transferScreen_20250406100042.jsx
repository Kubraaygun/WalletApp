...
const TransferScreen = ({ navigation }) => {
  ...
  const handleConfirm = () => {
    ...
    const newBalance = balance - confirmData.amount;
    dispatch(setBalance(newBalance));

    // AsyncStorage'a kaydetmek için
    dispatch(saveToAsyncStorage(getState()));
    // Başarıyla gönderilen parametreler
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContainer}>
              ...
              <Text style={styles.modalText}>
                Alici : {confirmData?.phoneNumber || "Telefon numarası yok"}
              </Text>
              <Text style={styles.modalText}>
