...
const styles = StyleSheet.create({
  ...
  icon: {
    ...
    top: 0, // Başlığın hemen üstüne yerleştirmek için
    alignSelf: "center", // Yatayda ortalıyoruz
    width: 100, // Resim boyutunu istediğiniz gibi ayarlayabilirsiniz
    height: 100, // Resim boyutunu istediğiniz gibi ayarlayabilirsiniz
    marginTop: -60, // Başlık ve resim arasındaki boşluğu ayarlayabilirsiniz
  },
});
