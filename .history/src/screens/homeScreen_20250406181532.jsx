...
const HomeScreen = ({ navigation }) => {
  ...
  const transactionsWithDescription = data.transactions.map((transaction) => ({
    ...transaction,
    description: transaction.description || "Açıklama yok", // açıklama yoksa varsayılan bir açıklama ekle
  }));
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.PRIMARY }}>
      <View style={styles.container}>
        ...
        {transactions && transactions.length === 0 ? (
          ...
          <FlatList
            data={transactionsWithDescription}
