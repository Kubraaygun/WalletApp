...
const styles = StyleSheet.create({
  ...
  summaryStats: { flexDirection: "row", marginTop: Spacing.lg, paddingTop: Spacing.md, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.2)" },
  summaryStatItem: { flex: 1, alignItems: "center" },
  summaryStatValue: { ...TextStyles.h3, color: "#FFF" },
  summaryStatLabel: { ...TextStyles.caption, color: "rgba(255,255,255,0.7)" },
