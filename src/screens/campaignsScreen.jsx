...
const styles = StyleSheet.create({
  ...
  categoriesContainer: { paddingHorizontal: Spacing.md, paddingBottom: Spacing.md, gap: Spacing.xs },
  categoryChip: { flexDirection: "row", alignItems: "center", paddingHorizontal: Spacing.md, paddingVertical: Spacing.xs, borderRadius: BorderRadius.full, gap: Spacing.xxs, marginRight: Spacing.xs },
  categoryText: { ...TextStyles.labelSmall },
  scrollView: { flex: 1 },
  ...
  summaryAmount: { fontSize: 32, fontWeight: "700", color: "#FFF", marginTop: Spacing.xxs },
  summaryIcon: { width: 56, height: 56, borderRadius: 28, backgroundColor: "rgba(255,255,255,0.2)", justifyContent: "center", alignItems: "center" },
  summaryStats: { flexDirection: "row", marginTop: Spacing.lg, paddingTop: Spacing.md, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.2)", alignItems: "center" },
  summaryStatItem: { flex: 1, alignItems: "center", justifyContent: "center" },
  summaryStatValue: { ...TextStyles.h3, color: "#FFF" },
  summaryStatLabel: { ...TextStyles.caption, color: "rgba(255,255,255,0.7)", marginTop: 4 },
